...
print("[*] Starting full direct pagination extraction for ~26,000 records...")
...
all_extracted_rows = []
page_size = 100
max_pages = 300  # Covers up to 30,000 records
...
for page in range(1, max_pages + 1):
    ...
    try:
        ...
        print(f"[+] Page {page} fetched. Total records collected: {len(all_extracted_rows)}")
...
if all_extracted_rows:
    ...
    wb.save(output_path)
    print(f"[+] SUCCESS! Extracted {len(df)} total records into {output_path}")
else:
